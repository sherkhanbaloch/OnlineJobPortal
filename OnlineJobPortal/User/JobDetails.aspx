                        ...
                        <div class="row justify-content-between">
                                ...
                                <div class="single-job-items mb-50">
                                    <div class="job-items">
                                        <div class="company-img company-img-details">
                                            <a href="#">
                                                <img src="<%# GetImageURL(Eval("CompanyLogo")) %>" width="80" alt=""></a>
                                        </div>
                            ...
                            <div class="col-md-4 col-lg-4">
                                <div class="post-details3  mb-50">
                                    ...
                                    <ul>
                                        <li>Posted Date : <span><%# DataBinder.Eval(Container.DataItem, "CreatedDate", "{0: dd MMM yyyy}") %></span></li>
                                        <li>Location : <span><%# Eval("State") %></span></li>
                                        <li>Vacancy : <span><%# Eval("NoOfPosts") %></span></li>
                                        <li>Job Nature : <span><%# Eval("JobType") %></span></li>
                                        <li>Salary :  <span><%# Eval("Salary") %></span></li>
                                        <li>Last Date : <span><%# DataBinder.Eval(Container.DataItem, "LastDateToApply", "{0: dd MMM yyyy}") %></span></li>
                                    </ul>
                                    <div class="apply-btn2">
                                        <%-- <a href="#" class="btn">Apply Now</a>--%>
                                        <asp:LinkButton ID="btnApply" CssClass="btn" Text="Apply Now" CommandName="cmdApplyJob" runat="server"></asp:LinkButton>
                                    </div>
                                </div>
