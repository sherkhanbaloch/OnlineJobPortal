        ...
        <div class="container-fluid pt-4 pb-4">
            ...
            <div class="row mb-3 pt-sm-3 table-border-style">
                <div class="col-md-12 table-responsive">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-striped" EmptyDataText="No Record To Display" AutoGenerateColumns="false" AllowPaging="true" PageSize="5" DataKeyNames="contactID" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting">
