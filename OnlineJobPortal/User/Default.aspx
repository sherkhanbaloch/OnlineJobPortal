                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="search-box">
                                <div class="input-form">
                                    <asp:TextBox ID="titleTxt" placeholder="Job Tittle or keyword" runat="server" />
                                </div>
                                <div class="select-form">
                                    <div class="select-items">
                                        <asp:DropDownList ID="countryDDL" AppendDataBoundItems="True" DataTextField="countryName" DataValueField="countryName" runat="server" DataSourceID="SqlDataSource1">
                                ...
                                <div class="search-form">
                                    <a href="JobListing.aspx">Find job</a>
                                </div>
                            </div>
                        </div>
                    </div>
